...
const makePlot = (Params) => {
  ...
  const refinedData = Object(__WEBPACK_IMPORTED_MODULE_0__parametrize_js__["a" /* parametrize */])(__WEBPACK_IMPORTED_MODULE_1__assets_data_PG2016_json__["data"], Params);
